    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <form action="/Final_Reyes/controladores/empleados/guardar.php" method="POST" class="col-lg-8 border bg-light p-3">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="emp_puesto_cod">Codigo del Puesto</label>
                        <input type="number" min="1" name="emp_puesto_cod" id="emp_puesto_cod" class="form-control">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="number" min="1" name="emp_sex_cod" id="emp_sex_cod" class="form-control">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
